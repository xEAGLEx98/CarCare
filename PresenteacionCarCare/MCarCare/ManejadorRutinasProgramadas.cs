...
namespace MCarCare
{
    public class ManejadorRutinasProgramadas : ICrud
    {
        ...
        public void Borrar(dynamic entidad)
        {
            ...
            DialogResult resultado = MessageBox.Show(String.Format("¿Desea eliminar este registro {0}?", entidad.FkIdVehiculos), "!Atención!", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
